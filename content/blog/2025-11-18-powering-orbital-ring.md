---
title: "Powering the Orbital Ring"
slug: "powering-orbital-ring"
date: 2025-11-18
author: "Paul G. de Jong"
type: post
status: publish
categories: [Orbital Ring, Space Engineering, Space Physics]
excerpt: "Perovskites are redefining solar power and superconductivity. In the future they could be powering an orbital ring, and feed energy to Earth."
---

> [More about Perovskites](#perovskites)
> [A Self-Powered Megastructure](#self-powered)
> [Solar Panels in Space](#solar-panels-space)
> [Power for the Day and Night Side](#power-day-night)
> [How Much Power Are We Talking About?](#how-much-power)
> [Powering the Night Side](#powering-night-side)
> [From Perovskites to Superconductors](#perovskites-superconductors)
> [Final Thoughts](#final-thoughts)

![](@ET-DC@eyJkeW5hbWljIjp0cnVlLCJjb250ZW50IjoicG9zdF9mZWF0dXJlZF9pbWFnZSIsInNldHRpbmdzIjp7fX0=@)

Image credit: [https://www.solliance.eu/2019/announcing-epki-the-european-perovskite-initiative/](https://www.solliance.eu/2019/announcing-epki-the-european-perovskite-initiative/)
...
In [my last blog post](https://www.orbitalring.space/blog/perovskites-type-ii-superconductors/), I explored perovskites, emphasizing how this remarkable class of materials underpins innovations ranging from solar cells to superconductors. They are tunable crystalline frameworks that can be engineered to exhibit almost any desired optical or electronic property.
...
*"What are Perovskite Solar Cells? Halide perovskites are a family of materials that have shown potential for high performance and low production costs in solar cells. The name “perovskite” comes from the nickname for their crystal structure, although other types of non-halide perovskites (such as oxides and nitrides) are utilized in other energy technologies, such as fuel cells and catalysts. Perovskite solar cells have shown remarkable progress in recent years with rapid increases in efficiency, from reports of about 3% in 2009 to over 25% today. While perovskite solar cells have become highly efficient in a very short time, a number of challenges remain before they can become a competitive commercial technology.*" ([June 1, 2022](https://www.energy.gov/eere/solar/perovskite-solar-cells)).

In this follow-up article, we’ll look at how these same materials could one day power one of humanity’s most ambitious megastructures, the [orbital ring](https://www.orbitalring.space/buy-book/).

### A Self-Powered Megastructure

One of the more surprising conclusions in[Orbital Ring Engineering](https://www.orbitalring.space/buy-book/) is that **the ring can power itself**, even during its deployment phase, when it’s not yet connected to the ground.
...
Earth's horizon and the International Space Station's solar array panels are featured in this image photographed by the Expedition 17 crew on August 4, 2008. NASA, [Public domain, via Wikimedia Commons]
...
To translate it into yearly energy see the following table.
...
Scene of an extended solar array experiment (SAE) panel during the OAST-1 experiment. View was shot from the orbiter window by one of the STS 41-D crewmembers. September 2, 1984. [NASA public domain [https://images.nasa.gov/details/41d-01-0021](https://images.nasa.gov/details/41d-01-0021)]
...
This brings the story full circle. The same class of **perovskite materials** that is breaking solar-cell efficiency records also defines many [type II superconductors](https://www.orbitalring.space/blog/perovskites-type-ii-superconductors/), such as **YBa₂Cu₃O₇ (YBCO)**. Perovskite-based superconductors can sustain immense currents while remaining stable in high magnetic fields, which is exactly what’s required for the ring’s levitation, power transport, and fault-current-limiting systems.
...
Perovskite solar cell. Dennis Schroeder / National Renewable Energy Laboratory, [Public domain, via Wikimedia Commons]
...
I would put my money on within 200 years for the orbital ring. That’s the promise of [Orbital Ring Engineering](https://www.orbitalring.space/buy-book/): physics you can build.
