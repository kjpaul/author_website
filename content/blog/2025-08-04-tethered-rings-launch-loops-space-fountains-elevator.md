---
title: "Tethered Rings, Launch Loops, Space Fountains, and The Space Elevator"
slug: "tethered-rings-launch-loops-space-fountains-elevator"
date: 2025-08-04
author: "Paul G. de Jong"
type: post
status: publish
categories: [Mass Drivers, Orbital Ring, Science Fiction, Space Engineering]
excerpt: "Follow-up to The Gravity Well, exploring Space Transit Systems such as Tethered Rings, Launch Loops, Space Fountains, and The Space Elevator."
---

> [Tethered Rings](#tethered-rings)
> [Launch Loops (Lofstrom Loop)](#launch-loops)
> [Space Fountains](#space-fountains)
> [The Space Elevator](#space-elevator)
> [Hystory of The Space Elevator](#history-space-elevator)
...
This article continues the exploration of **Space Transit Systems** from the previous article [Chapter Three: The Gravity Well](https://www.orbitalring.space/blog/chapter-three-gravity-well/), and expands into space transit infrastructures such as tethered rings, launch loops, space fountains, space elevators and The SkyHook.
...
**There are two significant issues** that are likely to be showstoppers for the tethered ring. The first is that the particle beam inside the tube will be much harder to implement than manufacturing a cable at orbital speed. As you will learn in the section on building the orbital ring (in the book [Orbital Ring Engineering](https://www.orbitalring.space/buy-book/)), creating the cable for the orbital ring is a direct process. While it's challenging due to the sheer volume of it, it is something we know how to do.
...
Launch loop (not to scale). The red marked line is the moving loop itself, blue lines are stationary cables. Diagram of a en:launch loop as envisioned by Keith Lofstrom. Wikipedia Creative Commons licence [https://en.wikipedia.org/wiki/Launch_loop#/media/File:LaunchLoop.svg](https://en.wikipedia.org/wiki/Launch_loop#/media/File:LaunchLoop.svg)
...
Image created by fenn_fukai with inkscape 0.40; original svg can be found at http://fenn.freeshell.org/space_fountain.svg. WikiMedia Creative Commons licence [https://commons.wikimedia.org/wiki/File:Space_fountain-v1.1.png](https://commons.wikimedia.org/wiki/File:Space_fountain-v1.1.png)
...
Now, let’s talk about the most popular of all speculative launch systems: the **space elevator**.

**The principle behind a space elevator is elegant**; it relies on the fact that the higher the orbit, the slower the orbit is relative to an observer on the surface of the Earth. Therefore, at some altitude above the equator, there exists an orbit where a satellite orbiting the Earth would appear stationary.

This occurs for a satellite in the equatorial great-circle plane of the Earth at 35,786 km (*22,236 miles*) above sea level. At that altitude, the force of gravity is only 0.22 m/s², and the centrifugal force of the geosynchronous orbit is -0.22 m/s²; thus, the apparent gravity is 0 m/s².

Just to be clear, all orbits work like this: first, find the force of gravity (*g_orbit*) for the orbit in question. Then, calculate the velocity of the satellite such that the centrifugal force equals negative g_orbit. The satellite then experiences what is called microgravity.

This calculation is easy to perform if the satellite is in a perfectly circular orbit. **The calculation becomes somewhat more challenging** if the orbit is elliptical. Thank goodness for computers when calculating a move between orbits.

Fortunately for us, **NASA** has created a program called **GMAT** (*General Mission Analysis Tool*) that is freely available to us mere humans. GMAT allows you to calculate a trajectory, just in case you have a rocket and want to send a letter to the *Shackleton Crater* on the Moon.

<!-- TODO: image (was WordPress wp-content reference) -->

Space elevator structural diagram. WikiMedia Creative Commons licence [https://commons.wikimedia.org/wiki/File:Space_elevator_structural_diagram.svg](https://commons.wikimedia.org/wiki/File:Space_elevator_structural_diagram.svg)
...
Concept of a space elevator by Yoshiki Yamagiwa at ResearchGate. Copyright Yoshiki Yamagiwa [https://www.researchgate.net/figure/Concept-of-a-space-elevator_fig1_259130798](https://www.researchgate.net/figure/Concept-of-a-space-elevator_fig1_259130798)
...
Keep following our blog, check out our social media spaces for further content and interaction, and don't forget to get yourself a copy of the book [Orbital Ring Engineering](https://www.orbitalring.space/buy-book/), available both in hard cover and Kindle versions!
